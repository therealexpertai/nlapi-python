...
from nlapi.cloud.client import ExpertAiClient
from nlapi.common.errors import MissingParametersError
...
class ExpertAiClientTestCase(ExpertAiTestCase):
    ...
    @patch("nlapi.cloud.client.ExpertAiClient.get_method_name_for_endpoint")
    ...
    @patch("nlapi.cloud.validate.ExpertAiValidation.check_parameters")
    ...
    @patch("nlapi.cloud.client.ExpertAiClient.verify_request")
    ...
    @patch("nlapi.cloud.client.ObjectMapper")
