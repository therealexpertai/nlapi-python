...
from nlapi.common.errors import ParameterError
...
class ValidationTests(BaseTestCase):
    ...
    @patch("nlapi.cloud.validate.ExpertAiValidation.language_value_is_correct")
    ...
    @patch("nlapi.cloud.validate.ExpertAiValidation.resource_value_is_correct")
