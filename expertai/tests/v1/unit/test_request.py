...
class ExpertAiRequestTestCase(ExpertAiTestCase):
    def setUp(self):
        ...
        file_token_value = patch(
            "nlapi.v1.authentication.ExpertAiAuth.fetch_token_value"
        )
    ...
    @patch(
        "nlapi.v1.authentication.ExpertAiAuth.header",
    ...
    @patch("nlapi.v1.request.ExpertAiRequest.setup_raw_request")
