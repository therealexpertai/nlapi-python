...
from nlapi.v1.errors import MissingParametersError
...
class ExpertAiClientTestCase(ExpertAiTestCase):
    ...
    @patch("nlapi.v1.client.ExpertAiClient.get_method_name_for_endpoint")
    ...
    @patch("nlapi.v1.validate.ExpertAiValidation.check_parameters")
    ...
    @patch("nlapi.v1.client.ExpertAiClient.verify_request")
    ...
    @patch("nlapi.v1.client.ObjectMapper")
