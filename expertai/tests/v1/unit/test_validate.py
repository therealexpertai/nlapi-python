...
from nlapi.v1.errors import ParameterError
...
class ValidationTests(BaseTestCase):
    ...
    @patch("nlapi.v1.validate.ExpertAiValidation.language_value_is_correct")
    ...
    @patch("nlapi.v1.validate.ExpertAiValidation.resource_value_is_correct")
