...
class DeepLinguisticAnalysis(BaseTestCase):
    @patch("nlapi.v1.model.data_model.Token")
    @patch("nlapi.v1.model.data_model.Paragraph")
    @patch("nlapi.v1.model.data_model.Phrase")
    @patch("nlapi.v1.model.data_model.Knowledge")
    @patch("nlapi.v1.model.data_model.Sentence")
