...
class DeepLinguisticAnalysis(BaseTestCase):
    @patch("expertai.nlapi.common.model.data_model.Token")
    @patch("expertai.nlapi.common.model.data_model.Paragraph")
    @patch("expertai.nlapi.common.model.data_model.Phrase")
    @patch("expertai.nlapi.common.model.data_model.Knowledge")
    @patch("expertai.nlapi.common.model.data_model.Sentence")
