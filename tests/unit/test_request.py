...
class ExpertAiRequestTestCase(ExpertAiTestCase):
    def setUp(self):
        ...
        file_token_value = patch(
            "expertai.nlapi.common.authentication.ExpertAiAuth.fetch_token_value"
        )
    ...
    @patch(
        "expertai.nlapi.common.authentication.ExpertAiAuth.header",
    ...
    @patch("expertai.nlapi.cloud.request.ExpertAiRequest.setup_raw_request")
