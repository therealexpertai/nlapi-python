...
from expertai.errors import ETypeError, EValueError, MissingArgumentError
from expertai.model import *
...
class DataModelsTestCase(BaseTestCase):
    ...
    def test_a_token_type_is_initialised_by_key(self):
        ...
        self.assertEqual(token_type.description_from_key, "Pronoun")
