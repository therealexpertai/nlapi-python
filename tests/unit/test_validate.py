...
class ValidationTests(BaseTestCase):
    ...
    @patch("expertai.nlapi.cloud.validate.ExpertAiValidation.language_value_is_correct")
    ...
    @patch("expertai.nlapi.cloud.validate.ExpertAiValidation.resource_value_is_correct")
