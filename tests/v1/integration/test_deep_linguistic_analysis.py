...
class DeepLinguisticAnalysis(BaseTestCase):
    @patch("expertai.nlapi.v1.model.data_model.Token")
    @patch("expertai.nlapi.v1.model.data_model.Paragraph")
    @patch("expertai.nlapi.v1.model.data_model.Phrase")
    @patch("expertai.nlapi.v1.model.data_model.Knowledge")
    @patch("expertai.nlapi.v1.model.data_model.Sentence")
