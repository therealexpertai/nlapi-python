...
class DeepLinguisticAnalysis(BaseTestCase):
    @patch("expertai.v1.model.data_model.Token")
    @patch("expertai.v1.model.data_model.Paragraph")
    @patch("expertai.v1.model.data_model.Phrase")
    @patch("expertai.v1.model.data_model.Knowledge")
    @patch("expertai.v1.model.data_model.Sentence")
