...
from expertai.v1.authentication import ExpertAiAuth
from expertai.v1.errors import CredentialsError, ExpertAiRequestError
...
class ExpertAiAuthTestCase(ExpertAiTestCase):
    ...
    @patch("expertai.v1.authentication.ExpertAiAuth.fetch_token_value")
    ...
    @patch(
        "expertai.v1.authentication.ExpertAiAuth.token_is_valid",
