...
from expertai.v1.errors import ExpertAiRequestError
...
class ExpertAiRequestTestCase(ExpertAiTestCase):
    def setUp(self):
        ...
        file_token_value = patch(
            "expertai.v1.authentication.ExpertAiAuth.fetch_token_value"
        )
    ...
    @patch(
        "expertai.v1.authentication.ExpertAiAuth.header",
    ...
    @patch("expertai.v1.request.ExpertAiRequest.setup_raw_request")
