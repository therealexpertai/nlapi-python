...
class ExpertAiRequestTestCase(ExpertAiTestCase):
    def setUp(self):
        ...
        file_token_value = patch(
            "expertai.nlapi.v1.authentication.ExpertAiAuth.fetch_token_value"
        )
    ...
    @patch(
        "expertai.nlapi.v1.authentication.ExpertAiAuth.header",
    ...
    @patch("expertai.nlapi.v1.request.ExpertAiRequest.setup_raw_request")
