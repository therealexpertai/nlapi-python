...
from expertai.nlapi.v1.client import ExpertAiClient
from expertai.nlapi.v1.errors import MissingParametersError
...
class ExpertAiClientTestCase(ExpertAiTestCase):
    ...
    @patch("expertai.nlapi.v1.client.ExpertAiClient.get_method_name_for_endpoint")
    ...
    @patch("expertai.nlapi.v1.client.ObjectMapper")
