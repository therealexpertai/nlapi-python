...
from expertai.v1.client import ExpertAiClient
from expertai.v1.errors import MissingParametersError
...
class ExpertAiClientTestCase(ExpertAiTestCase):
    ...
    @patch("expertai.v1.client.ExpertAiClient.get_method_name_for_endpoint")
    ...
    @patch("expertai.v1.validate.ExpertAiValidation.check_parameters")
    ...
    @patch("expertai.v1.client.ExpertAiClient.verify_request")
    ...
    @patch("expertai.v1.client.ObjectMapper")
