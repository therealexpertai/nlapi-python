...
from expertai.v1.errors import ObjectMapperError
...
class ObjectMapperTestCase(BaseTestCase):
    ...
    @patch("expertai.v1.object_mapper.DataModel")
    ...
    @patch("expertai.v1.object_mapper.ObjectMapper.precheck_references")
