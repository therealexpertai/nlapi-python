...
from expertai.v1.errors import ParameterError
...
class ValidationTests(BaseTestCase):
    ...
    @patch("expertai.v1.validate.ExpertAiValidation.language_value_is_correct")
    ...
    @patch("expertai.v1.validate.ExpertAiValidation.resource_value_is_correct")
