# Demonstrates the use of the self-documentation resource 'taxonomy' of the expert.ai (Cloud based) Natural Language API for the Behavioral traits document classification taxonomy
...
print("behavioral-traits taxonomy category tree:\n")
